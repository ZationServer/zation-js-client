...
import {
    ChannelReactionOnKickOut,
    ChannelReactionOnPublish,
    ChannelReactionOnSubscribe,
    ChannelReactionOnSubscribeFail,
    ChannelReactionOnUnsubscribe
...
import {ChannelEvent, ChannelTarget} from '../../channel/channelDefinitions';
